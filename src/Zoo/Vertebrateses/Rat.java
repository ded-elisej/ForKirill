...
public class Rat extends NonPredators implements Pets {
    ...
    public String whoIAm() {
        String inform = "I'm vertebrates, i'm non-predator. My name is rat";
        return inform;
    }
    ...
    public String inform(){
        String informAboutThisAnimal = "Hi, i'm rat. I am a small animal that can adapt to any conditions.";
        return informAboutThisAnimal;
    }
    public String toString(){
        return iHaveSkeleton() + iAmMammals() + iAmNonPredator() + canILiveAtHome() + inform();
    }
}
